...
RosNode::RosNode():Node("joy_qt"), joy_name("....")
{
    ...
    button_pub    = this->create_publisher<example_interfaces::msg::String>("button_state",10);
    ball_pub      = this->create_publisher<geometry_msgs::msg::Twist>("ball_state",10);
}
...
void RosNode::setJoyName(const example_interfaces::msg::String::SharedPtr msg)
 {
    joy_name = msg->data;
